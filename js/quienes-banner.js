(function () {
  const section = document.querySelector(".quienes-hero-banner");
  const host = document.querySelector("[data-quienes-banner-media]");
  if (!section || !host) return;

  const cfg = window.YAAVS_QUIENES_BANNER || {};
