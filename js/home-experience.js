(function () {
  ...
  const SERVICE_PANELS = {
    prepago: {
      ...
      title: "Prepago",
      desc: "Vende chips, paquetes y recargas de alta rotación para acelerar ventas diarias en tu punto YAAVS.",
      steps: [
        "Valida inventario de SIM prepago disponibles por operador.",
        "Abre RecargaKlic y selecciona activación prepago.",
        "Captura datos del cliente y completa la activación de la línea.",
    ...
    postpago: {
      ...
      title: "Pospago",
      desc: "Gestiona altas y renovaciones pospago con seguimiento comercial y respaldo operativo YAAVS.",
      steps: [
        "Identifica el perfil del cliente y el plan pospago adecuado.",
        "Reúne documentación requerida y valida datos del titular.",
        "Registra la solicitud en la plataforma indicada por el operador.",
        "Da seguimiento al alta y confirma activación con el cliente.",
      ],
      link: { href: "servicios.html", label: "Ver flujo pospago" },
    },
    recargaklic: {
      theme: "green",
      kicker: "App oficial",
      ...
      title: "RecargaKlic",
      desc: "Controla recargas y operación diaria desde una sola app para tu mostrador.",
      steps: [
        "Inicia sesión en RecargaKlic con tu cuenta de Yaavser.",
        "Selecciona el módulo de recargas o consulta.",
        "Ejecuta la operación y revisa el folio de confirmación.",
    ...
    portabilidad: {
      ...
      title: "Portabilidad",
      desc: "Cambia el número de tus clientes de una compañía a otra con respaldo de la red YAAVS.",
      steps: [
    ...
    "soporte-tecnico": {
      ...
      desc: "Resuelve fallas de operación y incidencias para mantener tu tienda activa y productiva.",
      steps: [
        "Detecta la incidencia y registra evidencias básicas del caso.",
        "Levanta el folio con datos de línea, equipo o transacción.",
        "Comparte información con soporte YAAVS por el canal oficial.",
        "Da seguimiento hasta el cierre y confirma solución con cliente.",
      ],
      link: { href: "contacto.html", label: "Solicitar soporte técnico" },
    },
    rotulaciones: {
      theme: "green",
      icon: "assets/hero-telecom/hero-portada-campeones.jpg",
      title: "Rotulaciones",
      desc: "Mejora la imagen de tu negocio con rotulación comercial alineada a la identidad YAAVS.",
      steps: [
        "Comparte fotos y medidas actuales de tu punto de venta.",
        "Define con YAAVS el concepto visual y materiales requeridos.",
        "Aprueba propuesta final de imagen y ubicación de piezas.",
        "Programa instalación y valida acabado final en sitio.",
      ],
    ...
    "academia-yaavs": {
      ...
      desc: "Capacitación práctica para ventas, atención al cliente y ejecución comercial en tienda.",
      steps: [
        "Revisa calendario de sesiones disponibles en Academia YAAVS.",
        "Inscribe a tu equipo por módulo según su rol comercial.",
        "Completa entrenamientos y actividades de aplicación en tienda.",
        "Mide resultados en conversión, ticket y calidad de atención.",
      ],
    ...
    esims: {
      ...
      title: "eSIMs",
      desc: "Activa líneas digitales sin chip físico. Confirma compatibilidad eSIM y elige AT&T, Movistar o BAIT.",
      steps: [
        "Confirma que el equipo del cliente sea compatible con eSIM.",
        "Elige la compañía: AT&T, Movistar o BAIT.",
        "Abre el portal oficial con el QR o el botón del panel.",
        "Escanea el código QR de activación con Wi-Fi y verifica señal.",
      ],
      link: { href: "#esim-modal", label: "Ver eSIM por compañía" },
    },
    vinculaciones: {
      theme: "coral",
      icon: "assets/servicios/vinculaciones.jpg",
      title: "Vinculaciones",
      desc: "Guía a tus clientes a vincular su línea en AT&T, Movistar o BAIT con pasos claros por compañía.",
      steps: [
        "Elige la compañía del cliente: AT&T, Movistar o BAIT.",
        "Revisa juntos los pasos específicos de esa compañía.",
        "Escanea el QR o abre el portal oficial de vinculación.",
        "Confirma que el cliente complete el trámite y conserve el comprobante.",
      ],
      link: { href: "#vinculaciones-modal", label: "Ver cómo vincular" },
    },
  };
