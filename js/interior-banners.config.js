/**
 * Imágenes de banner por página (hero-banner en assets/).
 */
window.YAAVS_PAGE_BANNERS = {
  ...
  servicios: {
    images: ["assets/hero-banner-2.jpg", "assets/hero-banner-3.jpg", "assets/hero-banner-4.jpg", "assets/hero-banner-5.jpg"],
    poster: "assets/hero-banner-1.jpg",
    interval: 5500,
  },
  "bolsa-trabajo": {
  ...
  contacto: {
    images: ["assets/hero-banner-1.jpg", "assets/hero-banner-5.jpg"],
    poster: "assets/hero-banner-2.jpg",
    interval: 6500,
  },
  testimonios: {
    images: [
